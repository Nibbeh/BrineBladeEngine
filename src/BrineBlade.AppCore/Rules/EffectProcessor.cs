...
{
    /// <summary>
    /// Centralizes the application of content-driven effects so NodeFlow and DialogueFlow don't duplicate logic.
    /// </summary>
    public sealed class EffectProcessor
    {
        ...
        /// <summary>
        /// Apply a sequence of effects. You can optionally provide callbacks that start a dialogue or combat encounter.
        /// </summary>
